    ...
    <>
      <section className="shell case-header">
        ...
        <p className="hero-sub">
          ...
          Oxygen worker runtime, built so its performance numbers can be
          regenerated by anyone who clones it.
        </p>
      ...
      <section className="shell section" aria-labelledby="problem">
        ...
        <div className="prose">
          <p>
            Performance results are difficult to revisit after the fact. The
            slower version of a storefront is usually replaced by the time anyone
            asks about it, so the numbers survive as a figure with no way to see
            what was measured, on what hardware, against what network profile, or
            across how many runs.
          </p>
          <p>
            I wanted this one to stay checkable — <strong>a measurement someone
            can re-run on their own machine</strong> and get the same shape of
            answer. That needs a slower version that still exists and still runs,
            which is why the storefront ships in two modes instead of one.
          </p>
        </div>
      </section>
      ...
      <section className="shell section" aria-labelledby="approach">
        ...
        <div className="prose" style={{ marginBottom: "2rem" }}>
          ...
          <p>
            ...
            . That is deliberate: it means a reviewer can read one file and know
            the complete list of differences between the two runs. Scattered
            through components as{" "}
            <code className="inline-code">if (baseline)</code> branches, the
            comparison would not be auditable.
          </p>
        </div>
      ...
      <section className="shell section" aria-labelledby="budgets">
        ...
        <div className="prose" style={{ marginBottom: "2rem" }}>
          <p>
            Lighthouse CI runs on every pull request against fixed thresholds,
            and a regression fails the check. Writing the targets down is the
            easy half;{" "}
            <strong>having them enforced automatically is what makes them hold
            when a release is due on Friday.</strong>
          </p>
        </div>
      ...
      <section className="shell section" aria-labelledby="evidence">
        ...
        <div className="prose" style={{ marginTop: "2.5rem" }}>
          <p>
            <strong>What this does not cover.</strong> The public mock API is
            ...
            exercised here. The catalog is small, so nothing in it speaks to
            behaviour at a hundred thousand SKUs. And lab numbers are a pre-merge
            gate rather than a substitute for field data — a production storefront
            should be governed by what real visitors experience.
          </p>
        </div>
      </section>
    </>
