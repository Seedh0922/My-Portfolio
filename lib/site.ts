...
export type Project = {
  ...
  name: string;
  kicker: string;
  /** One line for the card grid. The long `blurb` stays for the case study. */
  oneLiner: string;
  blurb: string;
...
export const projects: Project[] = [
  {
    ...
    oneLiner:
      "One storefront built twice — content in Liquid, then in sections and metafields — with twelve campaign requests replayed through both.",
    blurb:
  ...
  },
  {
    ...
    oneLiner:
      "A headless Hydrogen storefront shipped in two modes, so every performance number can be re-run by anyone who clones it.",
    blurb:
  ...
  },
  {
    ...
    oneLiner:
      "A webhook consumer that keeps stock correct under Shopify's at-least-once, out-of-order redelivery.",
    blurb:
  ...
  },
  {
    ...
    oneLiner:
      "An embedded Polaris app built around the Admin API's cost limit, where a naive retry loop drops writes and still reports success.",
    blurb:
